...
const min = (new Array(12).fill(0)).map((val, ind) => { return ind * 5 })
    ...
    <div className="eventCalendar">
      ...
      <div>
        ...
        <select onChange={(e) => {
          ...
          var t1 = newEvent.start.getFullYear();
          var t2 = newEvent.start.getMonth() + 1;
          var t3 = newEvent.start.getDate();
          var t4 = e.target.value;
          // console.log(t1+t2)
          // console.log(t1);
          // console.log(t2);
          // console.log(t3);
        ...
        <select onChange={(e) => {
          ...
          // console.log(temp)
          console.log(temp)
          var t6 = temp + ':' + (e.target.value||'00') + ':00'
          console.log(t6)
      ...
      <Calendar
        ...
        style={{ height: 500 }}
        selectable={true}
        onSelectSlot={(e) => { console.log(e.start) }}
        onSelectEvent={(e) => { console.log(e.title); console.log(e.start); }} />
    </div>
  );
};
